...
class Manifest(Document):
	...
	def get_dashboard_data(self):
		...
		hbl_container_nos = set(c.container_no for c in self.hbl_containers if c.container_no)
		...
		received_units = frappe.db.count("Container Reception", {"manifest": self.name, "docstatus": 1})
