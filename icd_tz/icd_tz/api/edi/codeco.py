...
class CODECOGenerator:
	...
	def get_body_segments(self, message_function: str) -> list[str]:
		...
		segments = [
			...
			# PIL asked for a numeric reference here, not our document name. The interchange
			# reference is numeric, unique, and already ties the message to UNH, UNT and UNZ.
