...
def get_columns():
	return [
		...
		{"fieldname": "container_size", "label": _("Size"), "fieldtype": "Data", "width": 120},
		{
		...
		{"fieldname": "seal", "label": _("Seal"), "fieldtype": "Data", "width": 250},
		{"fieldname": "posting_datetime", "label": _("Date"), "fieldtype": "Datetime", "width": 150},
		{
		...
		{"fieldname": "truck", "label": _("Truck"), "fieldtype": "Link", "options": "Vehicle", "width": 150},
		{
			"fieldname": "trailer",
			"label": _("Trailer"),
			"fieldtype": "Link",
		...
		{"fieldname": "driver", "label": _("Driver"), "fieldtype": "Link", "options": "Driver", "width": 150},
		{"fieldname": "driver_lisence", "label": _("Lisence"), "fieldtype": "Data", "width": 150},
		{
